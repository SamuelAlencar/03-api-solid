...
vitest_1.describe('Create Gym (e2e)', function () {
    ...
    vitest_1.it('should be able to create a gym', function () { return __awaiter(void 0, void 0, void 0, function () {
        var token, profileResponse;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    vitest_1.expect(profileResponse.statusCode).toEqual(201);
                    return [2 /*return*/];
            }
        });
    }); });
